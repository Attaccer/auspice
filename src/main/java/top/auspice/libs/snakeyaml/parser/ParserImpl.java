 ...
 * the License.
 */
package top.auspice.libs.snakeyaml.parser;
...
import top.auspice.libs.snakeyaml.LoaderOptions;
import top.auspice.libs.snakeyaml.comments.CommentType;
import top.auspice.libs.snakeyaml.error.Mark;
import top.auspice.libs.snakeyaml.error.YAMLException;
import top.auspice.libs.snakeyaml.events.*;
import top.auspice.libs.snakeyaml.nodes.Tag;
import top.auspice.libs.snakeyaml.reader.StreamReader;
import top.auspice.libs.snakeyaml.scanner.Scanner;
import top.auspice.libs.snakeyaml.scanner.ScannerImpl;
import top.auspice.libs.snakeyaml.tokens.*;
import top.auspice.libs.snakeyaml.util.ArrayStack;
