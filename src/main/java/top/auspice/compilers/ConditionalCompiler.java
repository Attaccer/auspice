...
import top.auspice.compilers.expressions.ConditionalExpression;
...
public final class ConditionalCompiler {
    ...
    public ConditionalCompiler(String var1, int var2, int var3) {
        this.a = var2 != 0 ? var1 : var1.replace('\n', ' ').replace('\r', ' ');
        this.c = var2;
        this.b = var3;
    }

    public static ConditionalCompiler compile(String var0) {
        return new ConditionalCompiler(var0, 0, var0.length());
    }
    ...
    private void a(boolean var1) {
        if (this.f != -1) {
            ...
            b var10000;
            if (var3) {
                var10000 = new b(ConditionalCompiler.OperandType.VARIABLE, 0);
            } else {
                ...
                if (var2.charAt(0) == '\'') {
                    ...
                    var10000 = new b(ConditionalCompiler.OperandType.STRING, var6);
                } else {
                    ...
                    var10000 = new b(var5 ? ConditionalCompiler.OperandType.VARIABLE : ConditionalCompiler.OperandType.ARITHMETIC, var6);
                }
            }

            b var10 = var10000;
            if (var10000.b != 0 && var10.a != ConditionalCompiler.OperandType.ARITHMETIC) {
            ...
            switch (var10.a.ordinal()) {
                case 0:
                    switch (var2) {
                        case "true":
                        case "else":
                            var11 = ConditionalCompiler.ConstantLogicalOperand.TRUE;
                            break label69;
                        case "false":
                            var11 = ConditionalCompiler.ConstantLogicalOperand.FALSE;
                            break label69;
                        case "null":
                        case "nil":
        ...
        if (this.d.size() >= 2) {
            if (this.e.size() == 2) {
                ...
                if (var5.isComparator() && var6.isComparator()) {
                    ...
                    var7 = this.a(var9, ConditionalCompiler.LogicalOperator.AND, var7);
                    this.d.add(var7);
                    this.e.clear();
                    return;
                }
    ...
    public void handleOp() {
        if (this.g != -1) {
            ...
            int var6 = (var5 = ConditionalCompiler.LogicalOperator.OPERATORS).length;
    ...
    public LogicalOperand evaluate() {
        for(; this.c < this.b; ++this.c) {
            int var1;
            char var2;
            if ((var2 = (char)(var1 = this.a.charAt(this.c))) == '<' || var2 == '>' || var2 == '!' || var2 == '=' || var2 == '&' || var2 == '|') {
                if (this.f != -1) {
                    this.a(false);
                    this.f = -1;
                }
                    ...
                    if (var1 == 40) {
                        ...
                        while(true) {
                            ...
                            if ((var7 = var8.a.charAt(var6)) == '(') {
                                ...
                                if (var4 == 0) {
                                    this.f = this.c++;
                                    LogicalOperand var3 = (new ConditionalCompiler(this.a, var1, var6)).evaluate();
                                    int finalVar = var1;
                                    int finalVar1 = var6;
    ...
    public abstract static class LogicalOperand implements ConditionalExpression {
        ...
        public Boolean eval(ConditionalVariableTranslator var1) {
            Object var2;
        ...
        public boolean isDefault() {
            return this == ConditionalCompiler.i;
        }
    ...
    public enum LogicalOperator {
        NOT("!", 1, new AcceptedOperand[]{ConditionalCompiler.LogicalOperator.AcceptedOperand.LOGICAL}, true) {
        ...
        public boolean isComparator() {
            return Arrays.stream(this.acceptedOperands).anyMatch((var0) -> {
                return var0 == ConditionalCompiler.LogicalOperator.AcceptedOperand.COMPARATOR;
            });
        }
        ...
        public boolean acceptsOperandOfType(LogicalOperand var1) {
            if (var1 instanceof LogicalVariableOperand) {
                ...
                AcceptedOperand var2 = var1 instanceof ArithmeticOperand ? ConditionalCompiler.LogicalOperator.AcceptedOperand.ARITHMETIC : ConditionalCompiler.LogicalOperator.AcceptedOperand.LOGICAL;
